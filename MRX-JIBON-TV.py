...
def notice():
	...
	subprocess.check_output(["am", "start", "https://www.facebook.com/jibon.islam65653?mibextid=ZbWKwL"])
...
class Main:
	def __init__(self):
		...
		self.loop = 0
		try:
			plr = requests.get('https://github.com/MRXJIBON/Mrx-Tv550/blob/main/Mrx-Tv550.txt').text
			if basesplit in plr:
				key = basesplit
